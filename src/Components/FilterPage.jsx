        ...
        <aside className="lg:col-span-1">
          <div className="bg-white rounded-lg p-4 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              <div className="font-medium"><TranslatedText>Filters</TranslatedText></div>
              <button onClick={clearFilters} className="text-sm text-orange-600"><TranslatedText>Clear</TranslatedText></button>
            </div>
